...
<head>
  ...
  <link rel="stylesheet" href="{{asset('assets/custom/jquery.datetimepicker.min.css')}}">
    <!-- summernote -->
    <link rel="stylesheet" href=""{{asset('assets/plugins/summernote/summernote-bs4.min.css')}}">
    <!-- CodeMirror -->
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{asset('assets/images/assignlogo.jpeg')}}" alt="AdminLTELogo" height="60" width="60"> 
  </div>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      @php
        $notification = getNotification(Auth::user()->emp_type,get_user_network(Auth::user()));
        $rework = 0;
        $fresh  = 0;
        if($notification){
          foreach ($notification as $key => $item) {
            if($item->assign_type=='Fresh'){
              $fresh++;
            }
            if($item->assign_type=='Rework'){
              $rework++;
            }
          }
        }
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <div class="dropdown-divider"></div>
          <a href="#" class="dropdown-item">
            <i class="fas fa-envelope mr-2"></i> <?=$fresh?> Fresh Job
            {{-- <span class="float-right text-muted text-sm">3 mins</span> --}}
          </a>
          <div class="dropdown-divider"></div>
          <a href="#" class="dropdown-item">
            <i class="fas fa-envelope mr-2"></i> <?=$rework?> Rework Job
            {{-- <span class="float-right text-muted text-sm">3 mins</span> --}}
          </a>
          {{-- <div class="dropdown-divider"></div>
          <a href="#" class="dropdown-item">
