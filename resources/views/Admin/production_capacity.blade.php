      ...
      <div class="row">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Find Production Capacity</h3>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            @if (session('success'))
        ...
        <div class="row">
            ...
            <div class="col-3">
                <div class="form-group">
                    ...
                    <input type="date" name="date" id="date" class="form-control" value="<?=date('d-m-Y')?>">
                  </div>
            </div>
            <div class="col-3">
                <div class="form-group">
       ...
       <script>
        $(".find").click(function(){
            if($("#date").val()!=''){
                ...
                $.ajax({
                url:'{{route("find-production-capacity")}}',
